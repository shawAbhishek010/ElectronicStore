...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<ProductSeed> products = List.of(
                ...
                new ProductSeed("seed-jbl-speaker", "JBL Flip Speaker", "Portable Bluetooth speaker with punchy sound and splash-resistant design.", 9999, 3999, 22, true, true, "audio", "https://images.unsplash.com/photo-1608043152269-423dbba4e7e1"),
                ...
                new ProductSeed("seed-sennheiser-accentum", "Sennheiser Accentum", "Wireless headphones with balanced sound, long battery life, and soft ear cushions.", 15990, 4499, 19, true, true, "audio", "https://images.unsplash.com/photo-1505740420928-5e560c06d30e"),
                ...
                new ProductSeed("seed-galaxy-buds-fe", "Samsung Galaxy Buds FE", "Comfortable everyday earbuds with active noise cancellation and clear calls.", 9999, 4299, 26, true, true, "audio", "https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb"),
                new ProductSeed("seed-soundcore-liberty-4-nc", "Soundcore Liberty 4 NC", "Feature-rich wireless earbuds with adaptive noise cancellation and app controls.", 8999, 3999, 24, true, true, "audio", "https://images.unsplash.com/photo-1610438235354-a6ae5528385c"),
                ...
                new ProductSeed("seed-ifb-microwave-25l", "IFB 25L Convection Microwave", "Convection microwave for baking, grilling, reheating, and everyday cooking.", 17990, 4999, 16, true, true, "home-appliances", "https://images.unsplash.com/photo-1574269909862-7e1d70bb8078"),
                ...
                new ProductSeed("seed-razer-blackwidow-v4", "Razer BlackWidow V4", "Mechanical gaming keyboard with RGB lighting and fast tactile switches.", 17999, 4999, 15, true, true, "gaming", "https://images.unsplash.com/photo-1541140532154-b024d705b90a"),
                new ProductSeed("seed-hyperx-cloud-iii", "HyperX Cloud III Headset", "Comfortable wired gaming headset with clear microphone and spatial audio support.", 9990, 4499, 21, true, true, "gaming", "https://images.unsplash.com/photo-1599669454699-248893623440"),
                new ProductSeed("seed-dualsense-controller", "Sony DualSense Controller", "Wireless PS5 controller with adaptive triggers and haptic feedback.", 6990, 4999, 24, true, true, "gaming", "https://images.unsplash.com/photo-1752833005527-38a858157afd"),
                ...
                new ProductSeed("seed-keyboard", "Mechanical Keyboard Pro", "RGB mechanical keyboard with tactile switches for typing and gaming.", 7999, 3999, 20, true, true, "accessories", "https://images.unsplash.com/photo-1587829741301-dc798b83add3"),
                ...
                new ProductSeed("seed-belkin-usb-c-hub", "Belkin USB-C Hub", "Multiport hub with HDMI, USB-A, card reader, and laptop-friendly pass-through power.", 6999, 4499, 25, true, true, "accessories", "https://images.unsplash.com/photo-1760376789487-994070337c76"),
                ...
                new ProductSeed("seed-oneplus-y1s-pro-43", "OnePlus TV Y1S Pro 43", "Everyday 4K smart television with clear sound, HDR support, and useful casting.", 39999, 32999, 21, true, true, "televisions", "oneplus-y1s-pro-43.jpg"),
